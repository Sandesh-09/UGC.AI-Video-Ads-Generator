      ...
      <div className="max-w-6xl mx-auto">
        ...
        {generations.length === 0 && (
          <div className="text-center py-20 bg-white/5 rounded-xl border border-white/10">
            ...
            <p className="text-gray-400 mb-6">Start Generating stunning product photos with AI</p>
            <PrimaryButton onClick={()=>window.location.href = '/generate'} className="mt-4">Generate Now</PrimaryButton>
          </div>
        )}
